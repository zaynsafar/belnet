...
namespace llarp
{
  namespace handlers
  {
                         ...
                         public std::enable_shared_from_this<TunEndpoint>
    {
      ...
      bool
      MapAddress(const service::Address& remote, huint128_t ip, bool MNode);
     ...
     protected:
      ...
      /// return true if we have a remote beldex address for this ip address
      bool
      ...
      /// maps key to true if key is a master node, maps key to false if key is
      /// a hidden service
      std::unordered_map<AlignedBuffer<32>, bool> m_MNodes;
