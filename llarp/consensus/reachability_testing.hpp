...
namespace llarp::consensus
{
  ...
  class reachability_testing
  {
   ...
   private:
    // Queue of pubkeys of master nodes to test; we pop off the back of this until the queue
    ...
    // Pubkeys, next test times, and sequential failure counts of master nodes that are currently
