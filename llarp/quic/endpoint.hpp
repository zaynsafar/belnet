...
namespace llarp::quic
{
  ...
  class Endpoint
  {
   ...
   protected:
    ...
    // Writes the belnet packet header to the beginning of `buf_`; the header is prepend to quic
   ...
   public:
    ...
    // Packet buffer we use when constructing custom packets to fire over belnet
