...
/**
 * "Trampoline" class that listens for UDP DNS packets on port 1053 coming from belnet's embedded
 ...
 *
 * So for a belnet configuration of "upstream=1.1.1.1", when exit mode is OFF:
